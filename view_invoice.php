...
<body>
    <div class="invoice-container">
        ...
        <div class="action-buttons no-print">
            ...
            <button onclick="emailInvoice()" class="btn btn-download" id="emailBtn">
        ...
        <div id="emailStatus" class="alert mt-3 no-print" style="display: none;"></div>
    </div>
    ...
    function emailInvoice() {
        ...
        .then(data => {
            ...
            if (data.success) {
                status.className = 'alert alert-success mt-3 no-print';
                status.innerHTML = '<i class="fa fa-check-circle"></i> ' + data.message;
            } else {
                status.className = 'alert alert-danger mt-3 no-print';
                status.innerHTML = '<i class="fa fa-exclamation-circle"></i> ' + data.message;
            }
            
            btn.disabled = false;
            btn.innerHTML = '<i class="fa fa-envelope"></i> Email Invoice';
        ...
        .catch(error => {
            status.style.display = 'block';
            status.className = 'alert alert-danger mt-3 no-print';
            status.innerHTML = '<i class="fa fa-exclamation-circle"></i> An error occurred. Please try again.';
